...
namespace Project_refer
{
    public partial class ProjectReferralWizard : System.Web.UI.Page
    {
        ...
        //protected void TextBoxApprentIssue_TextChanged(object sender, EventArgs e)
        //{

        //    string div = DropDownListDivision.SelectedItem.Text;
        //      div  = LabelDivision.Text;
        //    string dis = DropDownListDistric.SelectedItem.Text;
        //    dis= LabelDistric.Text;
        //    string teh = TextBoxTehsil.Text;
        //    teh= LabelTehsil.Text;
        //    string dep = DropDownListDepartment.SelectedItem.Text;
        //    dep= LabelDepartment.Text;
        //        TextBoxAssignTo.Text = LabelAssignTo.Text;
        //        TextBoxadpno.Text = LabelADPNO.Text;
        //        TextBoxName.Text = LabelName.Text;
        //        TextBoxProjCode.Text = LabelProjectCode.Text;
        //        TextBoxProjName.Text = LabelProjectName.Text;
        //        TextBoxName.Text = LabelName.Text;
        //        TextBoxDesgination.Text = LabelDesignation.Text;
        //        TextBoxContactNo.Text = LabelContact.Text;
        //        TextBoxApprentIssue.Text = LabelApparentIssue.Text;
